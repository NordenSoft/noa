...
import { arrayPush, arrayIncludes, arrayEvery, arrayLength, arrayJoin, dateParse, mapHas, mapGet, mapSet, newMap, newSet, objectKeys, objectGetOwnPropertyNames, isSafeInteger, arraySlice, setAdd, setSize, isArray, isNaNValue, jsonStringify } from "./intrinsics.js";
...
function verifyParsedChain(receipts: unknown, o: InertVerifyOptions): VerifyResult {
  ...
  const warnings: string[] = arraySlice(tenantDriftMessages); // captured copy, not a live iterator spread
